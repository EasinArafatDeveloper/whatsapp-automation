      ...
      <div className="hidden lg:flex lg:col-span-6 xl:col-span-7 bg-slate-950 text-white p-12 xl:p-16 flex-col justify-between relative overflow-hidden border-r border-slate-800">
        ...
        <div className="relative z-10 space-y-8 max-w-xl my-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-extrabold shadow-inner">
            ...
            <span>Join 500+ Businesses Automating WhatsApp</span>
          </div>

          <h1 className="text-3xl xl:text-4xl font-extrabold text-white leading-tight tracking-tight">
            Start Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-300 to-cyan-400">100% Free Account</span> & Automate Customer Sales.
          </h1>

          <p className="text-sm text-slate-400 font-medium leading-relaxed">
            Create an account in 30 seconds. No credit card required, no paid Meta API fees. Start capturing customer leads and sending instant AI replies today.
          </p>

          {/* Feature Badges Grid */}
          <div className="space-y-3.5 pt-2">
            {[
              { title: 'Instant QR & 8-Digit Pairing', desc: 'Connect your personal or business WhatsApp' },
              { title: 'Custom AI Knowledge Base', desc: 'Teach DeepSeek AI your products, prices and policies' },
              { title: 'Smart Intent & Priority Leads', desc: 'Automatic categorization of Hot Leads and Urgent inquiries' },
            ].map((feature, idx) => (
          ...
          <div className="p-4 rounded-2xl bg-gradient-to-r from-slate-900 to-slate-800 border border-slate-700/80 flex items-center justify-between shadow-2xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-xs font-bold text-white block">Free Forever SaaS Engine</span>
                <span className="text-[10px] text-slate-400 font-medium">Unlimited Customer Chats & Auto-Replies</span>
              </div>
            </div>
        ...
        <div className="max-w-md w-full mx-auto my-auto space-y-8 bg-white p-8 sm:p-10 rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50">
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-500 font-medium">
              Start automating your WhatsApp business customer service in less than a minute.
            </p>
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. Rahat Store / John Doe"
                  className="w-full pl-11 pr-4 py-3 rounded-2xl bg-slate-50 border border-slate-200 text-slate-900 text-sm focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10 focus:outline-none transition-all placeholder:text-slate-400 font-medium"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-11 py-3 rounded-2xl bg-slate-50 border border-slate-200 text-slate-900 text-sm focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10 focus:outline-none transition-all placeholder:text-slate-400 font-medium"
                  required
                  minLength={6}
                />
                <button
            ...
            <div className="pt-1">
              <label className="flex items-start gap-2.5 cursor-pointer select-none">
                <input
                  ...
                  className="w-4 h-4 rounded border-slate-300 text-blue-600 focus:ring-blue-500 cursor-pointer mt-0.5 shrink-0"
                  required
                />
